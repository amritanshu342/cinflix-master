...
<body>
            ...
            <div class="form login">
                ...
                <form action="ep_insert.php" method="post" enctype="multipart/form-data">
                    <div class="input-field">
                        <input type="text" placeholder="Enter your Episode Title" name="title" required>
                    ...
                    <div class="input-field">
                        <input type="text" placeholder="Enter redirect link" name="href" required>
                        <i class="uil uil-envelope icon"></i>
                    </div>
                    <div class="input-field">
    ...
    if (isset($_POST['upload'])) {
      ...
      $sql="INSERT INTO video(title,description,thumbnail,video,href)
      values('$title','$description','$thumbnail','$video','$href')";
