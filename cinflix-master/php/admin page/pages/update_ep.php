            ...
            <div class="form login">
                ...
                <form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="post">
                    <div class="input-field">
                        <input type="text" placeholder="Enter your Episode Title" name="title" value="<?php echo $info["title"]; ?>">
                        <i class="uil uil-envelope icon"></i>
                    </div>
                    <div class="input-field">
                        <input type="text" placeholder="Enter Category" name="description" value="<?php echo $info["description"]; ?>">
                        <i class="uil uil-envelope icon"></i>
                    </div>
                    <div class="input-field">
                        <input type="text" placeholder="Enter in which year" name="video" value="<?php echo $info["video"]; ?>">
                        <i class="uil uil-envelope icon"></i>
                    </div>
                    <div class="input-field">
                        <input type="text" placeholder="Enter redirect link" name="href" value="<?php echo $info["href"]; ?>">
                        <i class="uil uil-envelope icon"></i>
                    </div>
                    <div class="input-field">
                        <input type="text" placeholder="Enter thumblain url" value="<?php echo $info["thumbnail"]; ?>" name="thumbnail" >
                        <i class="uil uil-envelope icon"></i>
                    </div>
