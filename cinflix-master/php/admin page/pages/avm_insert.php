	...
	<section id="content">
		...
		<main>
			...
			<ul class="breadcrumbs">
				<li><a href="#">Home</a></li>
				<li>/</li>
				<li><a href="#" class="active">Insert AMV</a></li>
			</ul>
        ...
        <div class="forms">
            <div class="form login">
                <span class="title">AMV Insert</span>

                <form action="avm_insert.php" method="post" enctype="multipart/form-data">
                    <div class="input-field">
                        <input type="text" placeholder="Enter your AMV Title" name="title" required>
                        <i class="uil uil-envelope icon"></i>
                    </div>
                    <div class="input-field">
                        <input type="text" placeholder="Enter video channel logo" name="logo" required>
                        <i class="uil uil-envelope icon"></i>
                    </div>
                    <div class="input-field">
                        <input type="text" placeholder="Enter Video thumblain" name="thumbnail" required>
                        <i class="uil uil-envelope icon"></i>
                    </div>
                    <div class="input-field">
                        <input type="text" placeholder="Enter channel name" name="video" required>
                        <i class="uil uil-envelope icon"></i>
                    </div>
                    <div class="input-field">
                        <input type="text" placeholder="Enter video url" name="description" required>
                        <i class="uil uil-envelope icon"></i>
                    </div>
