    ...
    <header class="">
      <div class="navbar">
        ...
        <div class="navbar-actions">
          <form action="pages/episode/details.php" method="post" class="navbar-form">
          ...
          <a href="./pages/login/user_profile_update.php" class="navbar-signin">
            <span><img src="pages/login/uploaded_img/<?= $fetch_profile['image']; ?>" style="width: 50px;height: 50px;border-radius: 43px;"></span>
          </a>
...
<option class="category" value="<?php echo $info['category']; ?>" id="<?php echo $info['category']; ?>"><?php echo $info['category']; ?></option>
          <?php
         }
